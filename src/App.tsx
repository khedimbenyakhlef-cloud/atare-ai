...
export const translations: Record<string, any> = {
  fr: {
    nav: { home: 'Accueil', plants: 'Plantes', chat: 'Chat IA', about: 'À propos', login: 'Connexion' },
    hero: { title: 'El 3atare', title2: 'La pharmacopée authentique', desc: 'Intelligence artificielle, blockchain et sagesse ancestrale au service de votre santé.', cta: 'Consultez l\'IA', cta2: 'Explorer les plantes' },
    stats: { plants: 'Plantes', recipes: 'Recettes', languages: 'Langues', certifications: 'Certifications' },
    founder: 'Fondateur : KHEDIM BENYAKHLEF dit BENY-JOE',
    about: { title: 'Notre mission', desc: 'Préserver le patrimoine médicinal algérien et mondial grâce à la technologie.', founder: 'Fondateur', founderDesc: 'Ingénieur passionné par les plantes et la tech, KHEDIM BENYAKHLEF a conçu El 3atare pour reconnecter les générations à la médecine naturelle.' },
    chat: {
      welcome: '🌿 Salam ! Je suis El 3atare, votre herboriste IA. Posez-moi une question sur les plantes médicinales.',
      placeholder: 'Décrivez vos symptômes ou demandez une plante...',
      thinking: 'El 3atare réfléchit...',
      references: 'Plantes de référence',
      disclaimer: '⚠️ Ces conseils sont informatifs. Consultez toujours un médecin.'
    },
    plants: {
      search: 'Rechercher une plante...',
      all: 'Toutes',
      algerian: 'Algériennes',
      asian: 'Asiatiques',
  ...
  ar: {
    nav: { home: 'الرئيسية', plants: 'النباتات', chat: 'الدردشة', about: 'حول', login: 'تسجيل الدخول' },
    hero: { title: 'العطار', title2: 'الصيدلية التقليدية', desc: 'الذكاء الاصطناعي، البلوكشين والحكمة القديمة في خدمة صحتك.', cta: 'استشر العطار', cta2: 'استكشاف النباتات' },
    stats: { plants: 'نباتات', recipes: 'وصفات', languages: 'لغات', certifications: 'شهادات' },
    founder: 'المؤسس: قديم بن يخلف (بني جو)',
    about: { title: 'مهمتنا', desc: 'الحفاظ على التراث الطبي العالمي بفضل التكنولوجيا.', founder: 'المؤسس', founderDesc: 'مهندس شغوف بالنباتات والتكنولوجيا، قديم بن يخلف صمم العطار لربط الأجيال بالطب الطبيعي.' },
    chat: {
      welcome: '🌿 سلام ! أنا العطار، خبير الأعشاب. اسألني عن النباتات الطبية.',
      placeholder: 'صف أعراضك أو اسأل عن نبتة...',
      thinking: 'العطار يفكر...',
      references: 'نباتات مرجعية',
      disclaimer: '⚠️ هذه النصائح إعلامية فقط. استشر الطبيب دائمًا.'
    },
    plants: {
      search: 'ابحث عن نبات...',
      all: 'الكل',
  ...
  dz: {
    nav: { home: 'الدار', plants: 'النباتات', chat: 'الشات', about: 'علينا', login: 'الدخول' },
    hero: { title: 'العطار', title2: 'الصيدلية تاع الصح', desc: 'ذكاء اصطناعي وبلوكشين والحكمة القديمة لصحتك.', cta: 'سقسي العطار', cta2: 'شوف النباتات' },
    stats: { plants: 'نباتات', recipes: 'وصفات', languages: 'لوغات', certifications: 'شهادات' },
    founder: 'المؤسس: قديم بن يخلف (بني جو)',
    about: { title: 'مهمتنا', desc: 'نحافظو على التراث الطبي تاع الجزائر والعالم.', founder: 'المؤسس', founderDesc: 'مهندس يحب النباتات والتكنولوجيا، قديم بن يخلف صايب العطار باش يربط الجيل الجديد بالطب الطبيعي.' },
    chat: {
      welcome: '🌿 سلام خويا ! أنا العطار، نسقسي ونجاوبك على الأعشاب.',
      placeholder: 'قولي واش فيك ولا تسقسي على نبتة...',
      thinking: 'العطار راو يخمم...',
      references: 'نباتات مرجعية',
      disclaimer: '⚠️ هاد النصايح غير للمعلومات. روح للطبيب.'
    },
    plants: {
      search: 'قلب على نبتة...',
      all: 'الكل',
  ...
  en: {
    nav: { home: 'Home', plants: 'Plants', chat: 'AI Chat', about: 'About', login: 'Login' },
    hero: { title: 'El 3atare', title2: 'Authentic Pharmacopoeia', desc: 'AI, blockchain and ancestral wisdom for your health.', cta: 'Consult the AI', cta2: 'Explore Plants' },
    stats: { plants: 'Plants', recipes: 'Recipes', languages: 'Languages', certifications: 'Certifications' },
    founder: 'Founder: KHEDIM BENYAKHLEF alias BENY-JOE',
    about: { title: 'Our Mission', desc: 'Preserve medicinal heritage through technology.', founder: 'Founder', founderDesc: 'Passionate about plants and tech, KHEDIM BENYAKHLEF created El 3atare to reconnect generations with natural medicine.' },
    chat: {
      welcome: '🌿 Hello! I am El 3atare, your AI herbalist. Ask me about medicinal plants.',
      placeholder: 'Describe your symptoms or ask about a plant...',
      thinking: 'El 3atare is thinking...',
      references: 'Reference plants',
      disclaimer: '⚠️ This advice is informational only. Always consult a doctor.'
    },
    plants: {
      search: 'Search a plant...',
      all: 'All',
      algerian: 'Algerian',
      asian: 'Asian',
  ...
  de: {
    nav: { home: 'Start', plants: 'Pflanzen', chat: 'Chat', about: 'Über uns', login: 'Anmelden' },
    hero: { title: 'El 3atare', title2: 'Authentische Pharmakopöe', desc: 'KI, Blockchain und uraltes Wissen für Ihre Gesundheit.', cta: 'KI konsultieren', cta2: 'Pflanzen entdecken' },
    stats: { plants: 'Pflanzen', recipes: 'Rezepte', languages: 'Sprachen', certifications: 'Zertifizierungen' },
    founder: 'Gründer: KHEDIM BENYAKHLEF aka BENY-JOE',
    about: { title: 'Unsere Mission', desc: 'Das medizinische Erbe durch Technologie bewahren.', founder: 'Gründer', founderDesc: 'Als Pflanzen- und Technikenthusiast hat KHEDIM BENYAKHLEF El 3atare entwickelt, um Generationen mit Naturmedizin zu verbinden.' },
    chat: {
      welcome: '🌿 Hallo! Ich bin El 3atare, Ihr KI-Heilkräuter-Experte.',
      placeholder: 'Beschreiben Sie Ihre Symptome...',
      thinking: 'El 3atare denkt nach...',
      references: 'Referenzpflanzen',
      disclaimer: '⚠️ Diese Beratung dient nur der Information. Konsultieren Sie einen Arzt.'
    },
    plants: {
  ...
  kab: {
    nav: { home: 'Asebter', plants: 'Imɣan', chat: 'Tamsirt', about: 'Fellaneɣ', login: 'Kcem' },
    hero: { title: 'El 3atare', title2: 'Tasnajya taṣiḥant', desc: 'Tiknulujit n tsenselkimt d blockchain akked tmusni tamenzut i tezmert-nnek.', cta: 'Seqsi El 3atare', cta2: 'Wali imɣan' },
    stats: { plants: 'Imɣan', recipes: 'Tiɣawsiwin', languages: 'Tutlayin', certifications: 'Iselkimen' },
    founder: 'Amsiweḍ: KHEDIM BENYAKHLEF (BENY-JOE)',
    about: { title: 'Lqased-nneɣ', desc: 'Aḥarezz n tgemmi tamusnawt n imɣan s tiknulujit.', founder: 'Amsiweḍ', founderDesc: 'Anezzarfu iḥemmlen imɣan akked tiknulujit, KHEDIM BENYAKHLEF i d-isnulfan El 3atare akken ad yesselqem isuta s tmedyazt n ugama.' },
    chat: {
      welcome: '🌿 Azul fellak! Nekk d El 3atare, aneɣmas n imɣan. Seqsi-iyi-d.',
      placeholder: 'Mmel-d ayen i k-iḥuzan...',
      thinking: 'El 3atare la yettxemmim...',
      references: 'Imɣan n tmennaḍt',
      disclaimer: '⚠️ Tamnekta-agi d tinformatik kan. Ṛuḥ ɣer yimsuji.'
    },
    plants: {
      search: 'Nadi imɣan...',
      all: 'Akk',
      algerian: 'Izwura n Lezzayer',
      asian: 'Asyawi',
      mediterranean: 'Ilel',
      european: 'Urupi',
      tropical: 'Tropical'
...
export const LANGUAGES = [
  ...
  { code: 'dz', label: 'Darija', flag: '🇩🇿', dir: 'rtl' },
  { code: 'ar', label: 'العربية', flag: '🇸🇦', dir: 'rtl' },
  { code: 'en', label: 'English', flag: '🇬🇧', dir: 'ltr' },
  { code: 'de', label: 'Deutsch', flag: '🇩🇪', dir: 'ltr' },
  { code: 'kab', label: 'Taqbaylit', flag: '🇩🇿', dir: 'ltr' },
];

export type LangKey = 'fr' | 'dz' | 'ar' | 'en' | 'de' | 'kab';
